...
public class VentanaLogin {
	 ...
	 * 
	 * @return atributo usuario de la instancia
	 */
	...
	/**
	 * Devuelve el atributo Contrasenia
	 * 
	 * @return atributo contrasenia de la instancia
	 */
	...
	private void componentsProperties() {
		...
		frmLogin.setBounds(100, 100, 394, 269);
		frmLogin.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmLogin.setResizable(false);

		panel.setBackground(new Color(255, 204, 0));
		panel.setBounds(0, 0, 388, 240);
		...
		btn_salir.setIcon(new ImageIcon(
				VentanaLogin.class.getResource("/com/sun/javafx/scene/control/skin/caspian/dialog-error.png")));
